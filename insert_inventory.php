...
<title>inventory insert query</title>
<link rel="stylesheet" href="style.css">
</head>	
<body>
<h2>Insert Inventory Table</h2>
<form id="insertform" action="insert_process_inventory.php" method="post">
	<label for="inventoryID">Inventory ID: </label>
	<input type="number" name="inventory_id" id="inventory_id"/><br/>
