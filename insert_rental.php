...
<title>rental insert query</title>
<link rel="stylesheet" href="style.css">
</head>	
<body>
<h2>Insert Rental Table</h2>
<form id="insertform" action="insert_process_rental.php" method="post">
	<label for="rentalID">Rental ID: </label>
	<input type="number" name="rental_id" id="rental_id"/><br/>
	<label for="rentalDate">Rental Date: </label>
	<input type="datetime-local" name="rental_date" id="rental_date"/><br/>
	...
	<input type="datetime-local" name="return_date" id="return_date"/><br/>
