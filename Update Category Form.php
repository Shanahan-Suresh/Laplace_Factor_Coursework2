...
<form id="insertform" action="Update Category Process.php" method="POST">
<label>ID : <b><?php print $Category_ID;?></b></label>
<input type = "hidden" name ="category_id" value ='<?php print $Category_ID;?>'><br>
<label>Name :</label>
