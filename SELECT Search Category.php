...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by category name..." title="Type in an address">
...
echo "<tr><th>Name</th><th>Category Id</th></tr>";
...
while ($row = mysqli_fetch_array($result))
{
	...
	echo "<td><font size='4' color = '#006dea'>".$Name."</td>";
    	echo "<td><font size='4' color = '#ff7403'>".$Category_Id."</td>";
    echo "</tr>";
	//Printed rows
