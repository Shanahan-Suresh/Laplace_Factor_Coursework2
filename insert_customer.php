...
<title>customer insert query</title>
<link rel="stylesheet" href="style.css">
</head>	
<body>
<h2>Insert Customer Table</h2>
<form id="insertform" action="insert_process_customer.php" method="post">
	...
	<input type="datetime-local" name="create_date" id="create_date"/><br />
