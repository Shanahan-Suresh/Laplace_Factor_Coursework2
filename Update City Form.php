...
<form id="insertform" action="Update City Process.php" method="POST">
<label>City ID : <b><?php print $City_ID;?></b></label>
<input type = "hidden" name ="City_ID" value ='<?php print $City_ID;?>'><br>
<label>Name :</label>
