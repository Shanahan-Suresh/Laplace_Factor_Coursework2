...
<title>address insert query</title>
<link rel="stylesheet" href="style.css">
</head>	
<body>
<h2>Insert Address Table</h2>
<form id="insertform" action="insert_process_address.php" method="post">
	<label for="addressID">Address ID: </label>
	<input type="number" name="address_id" id="address_id"/><br />
	...
	<input type="number" name="postal_code" id="postal_code"/><br />
	<label for="phone">Phone: </label>
	<input type="tel" name="phone" id="phone" placeholder="(12345)123-1234" pattern="([0-9]){3-5}[0-9]{3}-[0-9]{4}"/><br />
